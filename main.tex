...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.2\textwidth]{images/seri_real.png} % ruta del archivo
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.25\textwidth]{images/L298N.png} % ruta del archivo
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{images/final_pp.jpg} % ruta del archivo
